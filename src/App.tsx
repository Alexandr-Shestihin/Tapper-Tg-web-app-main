...
import LotteryDrawing from "@/pages/lottery/drawing/page";
import LotteryTicket from "@/pages/lottery/ticket/page"; // 💡 новый
    ...
    <Layout>
      {/* <AuthGate> */}
        <Routes>
          ...
          <Route path="/lottery/drawing" element={<LotteryDrawing />} />
          <Route path="/lottery/ticket" element={<LotteryTicket />} />
        </Routes>
      {/* </AuthGate> */}
    </Layout>
  );
